          ...
          >
            <div className="mb-6">
              <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div>
                  <p className="text-sm font-600 text-blue-900">AI-Powered Analysis</p>
                  <p className="text-xs text-blue-700 mt-0.5">After submission, our AI will scan your product against 20+ compliance rules including certifications, labels, safety standards, and regional requirements.</p>
                </div>
              </div>
            </div>
