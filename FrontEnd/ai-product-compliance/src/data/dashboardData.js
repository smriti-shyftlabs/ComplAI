...
export const users = [
  ...
  { id: 'USR-008', name: 'ShyftLabs Team',   email: 'team@shyftlabs.io',           role: 'Admin',              department: 'Compliance',  avatar: 'ST', passwordHash: _h('complai123'), productsReviewed: 0,   approvalRate: '0%',  status: 'active', createdAt: '2024-01-01T00:00:00Z' },
];
